...
var Icon$e = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 19 16" }, props),
...
var Icon$v = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 35 24" }, props),
...
var Icon$B = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 80 80" }, props),
        React.createElement("g", { clipPath: "url(#clip0)" },
            ...
            React.createElement("path", { d: "M35.9629 36.0654L46.0085 38.7571L37.0016 72.3714L26.956 69.6797L35.9629 36.0654Z", fill: "#f27400" }),
            React.createElement("path", { d: "M11.8535 53.0029L14.5452 42.9573L61.111 55.4346L58.4193 65.4802L11.8535 53.0029Z", fill: "#f27400" }),
            React.createElement("g", { style: { mixBlendMode: "multiply" } },
                React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M30.0918 57.9047L40.1732 60.606L39.7591 62.1515L29.6777 59.4502L30.0918 57.9047ZM42.8724 50.5325L32.791 47.8312L33.2051 46.2857L43.2865 48.987L42.8724 50.5325Z", fill: "#f27400" })),
            ...
            React.createElement("path", { d: "M31.4707 20.8506L41.5163 18.1589L45.1398 31.6818L35.0942 34.3735L31.4707 20.8506Z", fill: "#f27400" }),
            React.createElement("g", { style: { mixBlendMode: "multiply" } },
                React.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M31.9671 22.5998L41.9672 19.7998L41.5673 17.9998L31.3975 20.8215L31.9671 22.5998Z", fill: "#f27400" }))),
        React.createElement("defs", null,
...
var SpinnerIcon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React.createElement("image", { width: "96", height: "96", href: "/images/robinia-ico.svg" })));
};
...
var Icon$$ = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 14 18" }, props),
...
var Logo$1 = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        React.createElement(Logo, { className: "mobile-icon" }),
...
var panelfooterbox = styled.div(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  background: rgba(255, 255, 255, 0.8);\n  padding: 20px;\n  border-radius: 20px;\n"], ["\n  background: rgba(255, 255, 255, 0.8);\n  padding: 20px;\n  border-radius: 20px;\n"])), MENU_ENTRY_HEIGHT);
var panelfootersubbox = styled.div(templateObject_5$3 || (templateObject_5$3 = __makeTemplateObject(["\n  width: 100%;\n  height: 50px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n"], ["\n  width: 100%;\n  height: 50px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n"])));
var panelfooterrbs= styled.div(templateObject_5$4 || (templateObject_5$4 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n"], ["\n  display: flex;\n  align-items: center;\n"])));
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container$4, null,
        React.createElement(panelfooterbox, null,
            React.createElement(panelfootersubbox, null,
                React.createElement(panelfooterrbs, null,
                    React.createElement(Icon$v, { width: "35px", height: "24px"}),
                    React.createElement(Text, { fontSize: "13px", color: "rgb(174, 174, 174)", marginleft: "4px"}, "RBS Price")),
                React.createElement(Text, { fontSize: "16px", color: "primary", bold: true}, "$" + cakePriceUsd.toFixed(3))))));
    //return (React.createElement(Container$4, null,
     //   React.createElement(SocialEntry, null,
    //        cakePriceUsd ? (React.createElement(PriceLink, { href: priceLink, target: "_blank" },
         //       React.createElement(Icon$v, { width: "35px", height: "24px", mr: "8px" }),
               // React.createElement(Text, { fontSize: "13px", color: "textSubtle", marginleft: "4px"}, "RBS Price"),
          //      React.createElement(Text, { fontSize: "16px", color: "primary", bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 })))));
...
//var templateObject_1$C, templateObject_2$c, templateObject_4$2;
//templateObject_3$7, 
...
var baseColors = {
    failure: "#ED4B9E",
    primary: "#046a38",//"#ffffff", #aa8929
    primaryBright: "#046a38",//"#ffffff", #aa8929
    primaryDark: "#046a38",//"#ffffff", #aa8929
...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "linear-gradient(90deg, rgba(213, 227, 228, 0.8) 1%, rgb(232, 235, 236) 100%)", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#27262c", gradients: {
        bubblegum: "linear-gradient(90deg, rgba(213, 227, 228, 0.8) 1%, rgb(232, 235, 236) 100%)",
